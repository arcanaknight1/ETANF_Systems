...
etanf.predicted <- data.frame(ETANF_pred = predict.glm(etanf.model, ETANFdata), County = ETANFdata$County, Year = ETANFdata$Year)
#etanf.predicted <- data.frame(ETANF_pred = predict.glm(etanf.model, filter(ETANFdata, !(County %in% c("Butler", "Greene", "McKean")))), County = ETANFdata$County, Year = ETANFdata$Year)
